...
/**
 * Welcome to the Commission Calculator.
 *
 * Jack Reynolds
 * 
 * 06/01/2020
...
public class CommissionWelcome implements ActionListener
{   
    ...
    public CommissionWelcome() 
    {
        //Build frame
        welcomeFrame = new JFrame("Weekly Sales Commision Calculator");
        ...
        ////////////////////////// LABEL //////////////////////
        //Build title
        titleLabel = new JLabel("The Commission Calculator");
        //Set bounds
        ...
        //Build welcome
        introLabel = new JLabel("The commission calculating application.");
        //Set bounds
    ...
    public void actionPerformed(ActionEvent event) 
    {
        ...
        {
         //Create a software object from CommissionCalc
         CommissionCalc start;
         //Allocate memory for the object 
         start = new CommissionCalc();
