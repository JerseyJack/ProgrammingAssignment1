/**
 * Welcome to the Average Calcu;ator
 *
 * Jack Reynolds
 * 
 * 06/03/2020
...
public class AverageWelcome implements ActionListener
{   
    ...
    public AverageWelcome() 
    {
        //Build frame
        welcomeFrame = new JFrame("Average Calculator");
        ...
        ////////////////////////// LABEL //////////////////////
        //Build title
        titleLabel = new JLabel("The Average Calculator");
        //Set bounds
        ...
        //Build welcome
        introLabel = new JLabel("Calculate the average of a set of numbers.");
        //Set bounds
    ...
    public void actionPerformed(ActionEvent event) 
    {
        ...
        {
         //Create a software object from AverageCalc
         AverageCalc start;
         //Allocate memory for the object 
         start = new AverageCalc();
